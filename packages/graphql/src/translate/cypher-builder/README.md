...
Also, the following **special** cases are exposed as clauses:

-   **db.FullTextQueryNodes**: Similar to Match, can be used for FullText queries
-   **RawCypher**: Allows for creating custom elements in the Cypher, these may contain arbitrary string and params.
