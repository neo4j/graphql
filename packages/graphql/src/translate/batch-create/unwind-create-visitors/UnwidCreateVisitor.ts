...
export class UnwindCreateVisitor implements Visitor<CypherBuilder.Clause> {
    ...
    visitNestedCreate(nestedCreate: INestedCreateAST): CypherBuilder.Clause {
        ...
        if (nestedCreate.edgeProperties && nestedCreate.edgeProperties.length) {
        ...
        if (nestedCreate.childrens) {
            const nestedVisitor = new UnwindCreateVisitor(nodeVar, this.context, this.rawInput, currentNode, [
                ...this.treePath,
