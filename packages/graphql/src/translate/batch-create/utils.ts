...
export function getAutoGeneratedFields(node: Node, cypherNodeRef: CypherBuilder.Node): CypherBuilder.SetParam[] {
...
export function fieldToSetParam(node: Node, cypherNodeRef: CypherBuilder.Node, key: string, value: CypherBuilder.Expr) {
