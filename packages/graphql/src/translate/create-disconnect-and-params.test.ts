    ...
    test("should return the correct disconnect", () => {
        ...
        expect(trimmer(result[0])).toEqual(
            ...
            CALL {
                ...
                WITH this, this0, this0_rel, [ metaVal IN [{type: 'Disconnected', name: 'Movie', toName: 'Movie', relationshipName: 'SIMILAR', id: id(this), toID: id(this0), relationshipID: id(this0_rel)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL AND (metaVal.toID IS NOT NULL OR metaVal.toName IS NULL) ] as this_mutateMeta
