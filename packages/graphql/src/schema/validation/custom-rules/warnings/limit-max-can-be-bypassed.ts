...
export function WarnIfAMaxLimitCanBeBypassedThroughInterface(): ASTVisitor {
    ...
    const doOnObject = {
        ...
        leave(objectType: ObjectTypeDefinitionNode | ObjectTypeExtensionNode) {
            ...
            const interfaceThatBypasses = (getInheritedTypeNames(objectType, interfaceToImplementingTypes) || []).find(
                (typeName) => {
