...
describe("parseMutationDirective", () => {
    test("should throw an error if incorrect directive is passed in", () => {
        ...
        expect(() => parseMutationDirective(directive)).toThrowErrorMatchingInlineSnapshot(
            `"Undefined or incorrect directive passed into parseMutationDirective function"`
        );
    });
