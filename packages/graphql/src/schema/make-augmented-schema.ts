            ...
            if (relationshipMeta) {
                ...
                if (typeMeta.name === "DateTime") {
                    ...
                    if (autogenerate) {
                        ...
                        if (!operations) {
                            throw new Error(`@autogenerated operations required`);
                        }

                        if (operations.value.kind !== "ListValue") {
                            throw new Error(`@autogenerated operations must be an array`);
                        }
                        ...
                        timestamps.forEach((op: TimeStampOperations, i) => {
                            if (!allowedOperations.includes(op)) {
                                throw new Error(`@autogenerated operations[${i}] invalid`);
                            }
                        });
