...
-   [`849316d`](https://github.com/neo4j/graphql/commit/849316d98bfb576b330e30f07430046557d9eb73) Thanks [@Liam-Doodson](https://github.com/Liam-Doodson)! - Fix an authentication and authorization bypass on GraphQL Subscriptions. A JWT supplied by the client in the WebSocket connection parameters was trusted without verification; subscriptions now authenticate only with a cryptographically verified `token`, and a pre-decoded JWT is trusted only when set on the server-side context.

## 5.12.13

### Patch Changes

-   [#7346](https://github.com/neo4j/graphql/pull/7346) [`b7d014c`](https://github.com/neo4j/graphql/commit/b7d014cba056dce0e506db3afcf8281ede889073) Thanks [@MacondoExpress](https://github.com/MacondoExpress)! - Parameterise AI provider API keys.
...
-   [#6621](https://github.com/neo4j/graphql/pull/6621) [`130722c`](https://github.com/neo4j/graphql/commit/130722ca90c7f86a3d0ea7c9685bb197154f93e2) Thanks [@angrykoala](https://github.com/angrykoala)! - Fix incorrect Cypher with authorization filters combined with authorization directive in a create operation
...
-   [#6455](https://github.com/neo4j/graphql/pull/6455) [`7c12030`](https://github.com/neo4j/graphql/commit/7c1203018d67f647fdc6f48ae0920ec994d1c81a) Thanks [@angrykoala](https://github.com/angrykoala)! - Fix Cypher error on nested update operations with authorization
...
-   [#6275](https://github.com/neo4j/graphql/pull/6275) [`8a993a8`](https://github.com/neo4j/graphql/commit/8a993a8a7f5a53aa3feaac3d2bf5c24161d4103b) Thanks [@angrykoala](https://github.com/angrykoala)! - Backport fix #6243: Handles Neo4j error "52N29" on CDC polling by refreshing the cursor. This error could be triggered in some cases by an outdated cursor.
...
-   [#5954](https://github.com/neo4j/graphql/pull/5954) [`dbd5e40`](https://github.com/neo4j/graphql/commit/dbd5e407b4a8def0daf228c1ed9a33545665cab5) Thanks [@angrykoala](https://github.com/angrykoala)! - Add support for CalVer editions of neo4j

## 5.11.3

### Patch Changes

-   [#5890](https://github.com/neo4j/graphql/pull/5890) [`f7358d0`](https://github.com/neo4j/graphql/commit/f7358d0aee04775d74bd36933e411db4a4054a1e) Thanks [@Masadow](https://github.com/Masadow)! - Fixed a bug that appears when filtering on interface relationships

-   [#5901](https://github.com/neo4j/graphql/pull/5901) [`06478b8`](https://github.com/neo4j/graphql/commit/06478b897f4f69bbcc68efc8f733e7c727ccdf55) Thanks [@a-alle](https://github.com/a-alle)! - Fix error message for wrong `requireAuthentication` argument on `@authorization` directive
