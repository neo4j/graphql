...
-   [#3858](https://github.com/neo4j/graphql/pull/3858) [`92d7e251e`](https://github.com/neo4j/graphql/commit/92d7e251e3799b41de595f3f51285f8f281d7d45) Thanks [@darrellwarde](https://github.com/darrellwarde)! - The `operations` argument of `@subscription` has been renamed to `events`, with each event being past tense. This mirrors naming used elsewhere for subscriptions.

-   [#3823](https://github.com/neo4j/graphql/pull/3823) [`dd7afb97f`](https://github.com/neo4j/graphql/commit/dd7afb97fa90946d5ae65721dd43737042d72c60) Thanks [@darrellwarde](https://github.com/darrellwarde)! - The `@id` directive has had a number of breaking changes.
