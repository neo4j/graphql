...
describe("https://github.com/neo4j/graphql/issues/3929", () => {
    ...
    beforeEach(async () => {
        ...
        const typeDefs = /* GraphQL */ `
            ...
            type ${Group} @authorization(validate: [{ when: [AFTER], where: { node: { creator_SINGLE: { id_EQ: "$jwt.uid" } } } }]) @node {
                id: ID! @id
                name: String
            ...
            type ${Person} @authorization(validate: [{ when: [AFTER], where: { node: { creator_SINGLE: { id_EQ: "$jwt.uid" }}}}]) @node {
                id: ID! @id
                name: String!
