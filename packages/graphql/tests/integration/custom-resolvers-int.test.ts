...
describe("Custom Resolvers", () => {
    ...
    describe("@cypher", () => {
        ...
        describe("cypherParams", () => {
            describe("should inject the cypherParams into cypher directive on queries and mutations", () => {
                test("query", async () => {
                    const session = driver.session();
                    ...
                    try {
                        const gqlResult = await graphql({
                            schema: neoSchema.schema,
                            source: query as string,
                            contextValue: { driver, cypherParams: { userId } },
                        });
            ...
            test("should inject the cypherParams into cypher directive on fields", async () => {
                const session = driver.session();
