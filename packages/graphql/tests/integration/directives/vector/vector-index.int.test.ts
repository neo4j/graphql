...
describe("@vector directive - indexes constraints", () => {
    ...
    test("should throw when index is missing fields", async () => {
        ...
        ).rejects.toThrow(`@vector index '${indexName}' on Node '${type.name}' is missing field 'description'`);
    });
    ...
    test("should throw when index is missing fields (using field alias)", async () => {
        ...
        await expect(
            ...
            `@vector index '${indexName}' on Node '${type.name}' is missing field 'description' aliased to field '${alias}'`
        );
    });
    ...
    test("should throw when index is missing fields when used with create option", async () => {
        ...
        await expect(
            ...
            `@vector index '${indexName}' on Node '${type.name}' already exists, but is missing field 'description'`
        );
    });
