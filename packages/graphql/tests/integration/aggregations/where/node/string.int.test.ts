...
describe("aggregations-where-node-string", () => {
    ...
    test("should return posts where a like String is EQUAL to", async () => {
        ...
        const query = `
                {
                    ${Post.plural}(where: { testString_EQ: "${testString}", likesAggregate: { node: { testString_EQUAL: "${testString}" } } }) {
                        testString
                        likes {
                            testString
                        }
    ...
    test("should return posts where a like String is GT than", async () => {
        ...
        const query = `
                {
                    ${Post.plural}(where: { testString_EQ: "${testString}", likesAggregate: { node: { testString_GT: ${gtLength} } } }) {
                        testString
                        likes {
                            testString
                        }
    ...
    test("should return posts where a like String is GTE than", async () => {
        ...
        const query = `
                {
                    ${Post.plural}(where: { testString_EQ: "${testString}", likesAggregate: { node: { testString_GTE: ${length} } } }) {
                        testString
                        likes {
                            testString
                        }
    ...
    test("should return posts where a like String is LT than", async () => {
        ...
        const query = `
                {
                    ${Post.plural}(where: { testString_EQ: "${testString}", likesAggregate: { node: { testString_LT: ${length} } } }) {
                        testString
                        likes {
                            testString
                        }
    ...
    test("should return posts where a like String is LTE than", async () => {
        ...
        const query = `
                {
                    ${Post.plural}(where: { testString_EQ: "${testString}", likesAggregate: { node: { testString_LTE: ${length} } } }) {
                        testString
                        likes {
                            testString
                        }
...
describe("aggregations-where-node-string relationships of interface types", () => {
    ...
    test("should return posts where a like String is EQUAL to - concrete relationship", async () => {
        ...
        const query = `
                {
                    things(where: { testString_EQ: "${testString}", likesAggregate: { node: { testString_EQUAL: "${testString}" } } }) {
                        testString
                        likes {
                            testString
                        }
