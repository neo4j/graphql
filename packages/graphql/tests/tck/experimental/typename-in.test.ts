...
describe("typename_IN", () => {
    ...
    test("top-level + connection where (TODO: REMOVE)", async () => {
        const query = gql`
            {
                actors(
                    where: {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WHERE (EXISTS {
                ...
                WHERE (this0.screenTime = $param0 OR (this1.title = $param1 OR this1:Series))
            } AND EXISTS {
                MATCH (this)-[this2:ACTED_IN]->(this3:Series)
                WHERE (this2.screenTime = $param2 OR (this3.title = $param3 OR this3:Series))
            } AND EXISTS {
                MATCH (this)-[this4:ACTED_IN]->(this5:Cartoon)
                WHERE (this4.screenTime = $param4 OR (this5.title = $param5 OR this5:Series))
            })
            CALL {
                WITH this
                CALL {
                    WITH *
                    MATCH (this)-[this6:ACTED_IN]->(this7:Movie)
                    WITH this7 { .title, __resolveType: \\"Movie\\", __id: id(this7) } AS this7
                    RETURN this7 AS var8
                    UNION
                    WITH *
                    MATCH (this)-[this9:ACTED_IN]->(this10:Series)
                    WITH this10 { .title, __resolveType: \\"Series\\", __id: id(this10) } AS this10
                    RETURN this10 AS var8
                    UNION
                    WITH *
                    MATCH (this)-[this11:ACTED_IN]->(this12:Cartoon)
                    WITH this12 { .title, __resolveType: \\"Cartoon\\", __id: id(this12) } AS this12
                    RETURN this12 AS var8
                }
                WITH var8
                RETURN collect(var8) AS var8
            }
            RETURN this { actedIn: var8 } AS this"
        `);
