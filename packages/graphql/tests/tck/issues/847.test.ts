        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                CALL {
                    ...
                    WITH this_subjects { __resolveType: \\"Person\\", .id, __id: id(this) } AS this_subjects
                    RETURN this_subjects AS this_subjects
                    UNION
                    WITH *
                    MATCH (this)<-[this1:ACTED_IN]-(this_subjects:\`Place\`)
                    WITH this_subjects { __resolveType: \\"Place\\", .id, __id: id(this) } AS this_subjects
                    RETURN this_subjects AS this_subjects
                }
                WITH this_subjects
            ...
            CALL {
                ...
                CALL {
                    ...
                    WITH this_objects { __resolveType: \\"Person\\", .id, __id: id(this) } AS this_objects
                    RETURN this_objects AS this_objects
                    UNION
                    WITH *
                    MATCH (this)-[this3:ACTED_IN]->(this_objects:\`Place\`)
                    WITH this_objects { __resolveType: \\"Place\\", .id, __id: id(this) } AS this_objects
                    RETURN this_objects AS this_objects
                }
                WITH this_objects
