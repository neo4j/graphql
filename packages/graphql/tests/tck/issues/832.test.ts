        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                CALL {
                    ...
                    WITH this0_subjects { __resolveType: \\"Person\\", __id: id(this0), .id } AS this0_subjects
                    RETURN this0_subjects AS this0_subjects
                    UNION
                    WITH *
                    MATCH (this0)<-[create_this1:ACTED_IN]-(this0_subjects:\`Place\`)
                    WITH this0_subjects { __resolveType: \\"Place\\", __id: id(this0), .id } AS this0_subjects
                    RETURN this0_subjects AS this0_subjects
                }
                WITH this0_subjects
            ...
            CALL {
                ...
                CALL {
                    ...
                    WITH this0_objects { __resolveType: \\"Person\\", __id: id(this0), .id } AS this0_objects
                    RETURN this0_objects AS this0_objects
                    UNION
                    WITH *
                    MATCH (this0)-[create_this3:ACTED_IN]->(this0_objects:\`Place\`)
                    WITH this0_objects { __resolveType: \\"Place\\", __id: id(this0), .id } AS this0_objects
                    RETURN this0_objects AS this0_objects
                }
                WITH this0_objects
            ...
            CALL {
                ...
                CALL {
                    ...
                    WITH this1_subjects { __resolveType: \\"Person\\", __id: id(this1), .id } AS this1_subjects
                    RETURN this1_subjects AS this1_subjects
                    UNION
                    WITH *
                    MATCH (this1)<-[create_this1:ACTED_IN]-(this1_subjects:\`Place\`)
                    WITH this1_subjects { __resolveType: \\"Place\\", __id: id(this1), .id } AS this1_subjects
                    RETURN this1_subjects AS this1_subjects
                }
                WITH this1_subjects
            ...
            CALL {
                ...
                CALL {
                    ...
                    WITH this1_objects { __resolveType: \\"Person\\", __id: id(this1), .id } AS this1_objects
                    RETURN this1_objects AS this1_objects
                    UNION
                    WITH *
                    MATCH (this1)-[create_this3:ACTED_IN]->(this1_objects:\`Place\`)
                    WITH this1_objects { __resolveType: \\"Place\\", __id: id(this1), .id } AS this1_objects
                    RETURN this1_objects AS this1_objects
                }
                WITH this1_objects
