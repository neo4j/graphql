        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                CALL {
                    ...
                    WITH this0_directors { __resolveType: \\"Actor\\", __id: id(this0), .name } AS this0_directors
                    RETURN this0_directors AS this0_directors
                    UNION
                    WITH *
                    MATCH (this0)<-[create_this1:DIRECTED]-(this0_directors:\`Person\`)
                    WITH this0_directors { __resolveType: \\"Person\\", __id: id(this0), .name } AS this0_directors
                    RETURN this0_directors AS this0_directors
                }
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                CALL {
                    ...
                    WITH this0_directors { __resolveType: \\"Actor\\", __id: id(this0), .name, movies: this0_directors_movies } AS this0_directors
                    RETURN this0_directors AS this0_directors
                    UNION
                    WITH *
