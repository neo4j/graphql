...
describe("Subscriptions metadata on create", () => {
    ...
    test("Create with create relation: connect event", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WITH meta + { event: \\"connect\\", id_node1: id(this0_actors0_node), id_node2: id(this0), id: id(this0_actors0_relationship), properties: { node1: this0_actors0_node { .* }, node2: this0 { .* }, relationship: this0_actors0_relationship { .* } }, timestamp: timestamp(), relationshipName: \\"ACTED_IN\\", node1Typename: \\"Actor\\", node2Typename: \\"Movie\\" } AS meta, this0, this0_actors0_node
    ...
    test("Create with nested create relation: connect event", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WITH meta + { event: \\"connect\\", id_node1: id(this0_actors0_node_movies0_node), id_node2: id(this0_actors0_node), id: id(this0_actors0_node_movies0_relationship), properties: { node1: this0_actors0_node_movies0_node { .* }, node2: this0_actors0_node { .* }, relationship: this0_actors0_node_movies0_relationship { .* } }, timestamp: timestamp(), relationshipName: \\"ACTED_IN\\", node1Typename: \\"Movie\\", node2Typename: \\"Actor\\" } AS meta, this0, this0_actors0_node, this0_actors0_node_movies0_node
            WITH meta + { event: \\"create\\", id: id(this0_actors0_node), properties: { old: null, new: this0_actors0_node { .* } }, timestamp: timestamp(), typename: \\"Actor\\" } AS meta, this0, this0_actors0_node
            MERGE (this0)<-[this0_actors0_relationship:ACTED_IN]-(this0_actors0_node)
            SET this0_actors0_relationship.screenTime = $this0_actors0_relationship_screenTime
            WITH meta + { event: \\"connect\\", id_node1: id(this0_actors0_node), id_node2: id(this0), id: id(this0_actors0_relationship), properties: { node1: this0_actors0_node { .* }, node2: this0 { .* }, relationship: this0_actors0_relationship { .* } }, timestamp: timestamp(), relationshipName: \\"ACTED_IN\\", node1Typename: \\"Actor\\", node2Typename: \\"Movie\\" } AS meta, this0, this0_actors0_node
    ...
    test("Create with create relation to union field: connect event", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WITH meta + { event: \\"connect\\", id_node1: id(this0_directors_Actor0_node), id_node2: id(this0), id: id(this0_directors_Actor0_relationship), properties: { node1: this0_directors_Actor0_node { .* }, node2: this0 { .* }, relationship: this0_directors_Actor0_relationship { .* } }, timestamp: timestamp(), relationshipName: \\"DIRECTED\\", node1Typename: \\"Actor\\", node2Typename: \\"Movie\\" } AS meta, this0, this0_directors_Actor0_node
            ...
            WITH meta + { event: \\"connect\\", id_node1: id(this0_directors_Person0_node), id_node2: id(this0), id: id(this0_directors_Person0_relationship), properties: { node1: this0_directors_Person0_node { .* }, node2: this0 { .* }, relationship: this0_directors_Person0_relationship { .* } }, timestamp: timestamp(), relationshipName: \\"DIRECTED\\", node1Typename: \\"Person\\", node2Typename: \\"Movie\\" } AS meta, this0, this0_directors_Person0_node
            WITH meta + { event: \\"create\\", id: id(this0), properties: { old: null, new: this0 { .* } }, timestamp: timestamp(), typename: \\"Movie\\" } AS meta, this0
            RETURN this0, meta AS this0_meta
            }
            WITH this0, this0_meta AS meta
    ...
    test("Create with nested create relation to union field: connect event", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WITH meta + { event: \\"connect\\", id_node1: id(this0_directors_Actor0_node_movies0_node), id_node2: id(this0_directors_Actor0_node), id: id(this0_directors_Actor0_node_movies0_relationship), properties: { node1: this0_directors_Actor0_node_movies0_node { .* }, node2: this0_directors_Actor0_node { .* }, relationship: this0_directors_Actor0_node_movies0_relationship { .* } }, timestamp: timestamp(), relationshipName: \\"ACTED_IN\\", node1Typename: \\"Movie\\", node2Typename: \\"Actor\\" } AS meta, this0, this0_directors_Actor0_node, this0_directors_Actor0_node_movies0_node
            WITH meta + { event: \\"create\\", id: id(this0_directors_Actor0_node), properties: { old: null, new: this0_directors_Actor0_node { .* } }, timestamp: timestamp(), typename: \\"Actor\\" } AS meta, this0, this0_directors_Actor0_node
            MERGE (this0)<-[this0_directors_Actor0_relationship:DIRECTED]-(this0_directors_Actor0_node)
            SET this0_directors_Actor0_relationship.year = $this0_directors_Actor0_relationship_year
            WITH meta + { event: \\"connect\\", id_node1: id(this0_directors_Actor0_node), id_node2: id(this0), id: id(this0_directors_Actor0_relationship), properties: { node1: this0_directors_Actor0_node { .* }, node2: this0 { .* }, relationship: this0_directors_Actor0_relationship { .* } }, timestamp: timestamp(), relationshipName: \\"DIRECTED\\", node1Typename: \\"Actor\\", node2Typename: \\"Movie\\" } AS meta, this0, this0_directors_Actor0_node
    ...
    test("Quadruple nested Create", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WITH meta + { event: \\"connect\\", id_node1: id(this0_actors0_node_movies0_node_actors0_node), id_node2: id(this0_actors0_node_movies0_node), id: id(this0_actors0_node_movies0_node_actors0_relationship), properties: { node1: this0_actors0_node_movies0_node_actors0_node { .* }, node2: this0_actors0_node_movies0_node { .* }, relationship: this0_actors0_node_movies0_node_actors0_relationship { .* } }, timestamp: timestamp(), relationshipName: \\"ACTED_IN\\", node1Typename: \\"Actor\\", node2Typename: \\"Movie\\" } AS meta, this0, this0_actors0_node, this0_actors0_node_movies0_node, this0_actors0_node_movies0_node_actors0_node
            WITH meta + { event: \\"create\\", id: id(this0_actors0_node_movies0_node), properties: { old: null, new: this0_actors0_node_movies0_node { .* } }, timestamp: timestamp(), typename: \\"Movie\\" } AS meta, this0, this0_actors0_node, this0_actors0_node_movies0_node
            MERGE (this0_actors0_node)-[this0_actors0_node_movies0_relationship:ACTED_IN]->(this0_actors0_node_movies0_node)
            WITH meta + { event: \\"connect\\", id_node1: id(this0_actors0_node_movies0_node), id_node2: id(this0_actors0_node), id: id(this0_actors0_node_movies0_relationship), properties: { node1: this0_actors0_node_movies0_node { .* }, node2: this0_actors0_node { .* }, relationship: this0_actors0_node_movies0_relationship { .* } }, timestamp: timestamp(), relationshipName: \\"ACTED_IN\\", node1Typename: \\"Movie\\", node2Typename: \\"Actor\\" } AS meta, this0, this0_actors0_node, this0_actors0_node_movies0_node
            WITH meta + { event: \\"create\\", id: id(this0_actors0_node), properties: { old: null, new: this0_actors0_node { .* } }, timestamp: timestamp(), typename: \\"Actor\\" } AS meta, this0, this0_actors0_node
    ...
    test("Multi Create with nested", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WITH meta + { event: \\"connect\\", id_node1: id(this1_actors0_node_movies0_node), id_node2: id(this1_actors0_node), id: id(this1_actors0_node_movies0_relationship), properties: { node1: this1_actors0_node_movies0_node { .* }, node2: this1_actors0_node { .* }, relationship: this1_actors0_node_movies0_relationship { .* } }, timestamp: timestamp(), relationshipName: \\"ACTED_IN\\", node1Typename: \\"Movie\\", node2Typename: \\"Actor\\" } AS meta, this1, this1_actors0_node, this1_actors0_node_movies0_node
            ...
            WITH meta + { event: \\"connect\\", id_node1: id(this1_actors0_node), id_node2: id(this1), id: id(this1_actors0_relationship), properties: { node1: this1_actors0_node { .* }, node2: this1 { .* }, relationship: this1_actors0_relationship { .* } }, timestamp: timestamp(), relationshipName: \\"ACTED_IN\\", node1Typename: \\"Actor\\", node2Typename: \\"Movie\\" } AS meta, this1, this1_actors0_node
            WITH meta + { event: \\"create\\", id: id(this1), properties: { old: null, new: this1 { .* } }, timestamp: timestamp(), typename: \\"Movie\\" } AS meta, this1
            RETURN this1, meta AS this1_meta
            }
            WITH this0, this1, this0_meta + this1_meta AS meta
