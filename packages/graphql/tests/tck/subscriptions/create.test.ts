            ...
            CALL {
                ...
                CALL {
                    ...
                    CALL {
                        ...
                        WITH create_this1 { .name, __resolveType: \\"Person\\", __id: id(this0) } AS create_this1
            ...
            CALL {
                ...
                CALL {
                    ...
                    CALL {
                        ...
                        WITH create_this4 { .name, movies: create_var7, __resolveType: \\"Actor\\", __id: id(this0) } AS create_this4
                        RETURN create_this4 AS create_var2
                    }
                    WITH create_var2
                    RETURN collect(create_var2) AS create_var2
