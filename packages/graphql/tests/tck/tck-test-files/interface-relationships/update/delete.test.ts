...
describe("Interface Relationships - Update delete", () => {
    ...
    test("Update delete an interface relationship", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WITH this, this_delete_actedIn_Movie0, collect(DISTINCT this_delete_actedIn_Movie0) as this_delete_actedIn_Movie0_to_delete, [ metaVal IN [{type: 'Deleted', name: 'Movie', id: id(this_delete_actedIn_Movie0)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL ] as mutateMeta
            ...
            WITH this, this_delete_actedIn_Series0, collect(DISTINCT this_delete_actedIn_Series0) as this_delete_actedIn_Series0_to_delete, mutateMeta + [ metaVal IN [{type: 'Deleted', name: 'Series', id: id(this_delete_actedIn_Series0)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL ] as mutateMeta
