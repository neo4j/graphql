...
describe("Cypher Create Pringles", () => {
    ...
    test("Create Pringles", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WITH this0, this0_mutateMeta + [ metaVal IN [{type: 'Created', name: 'Size', id: id(this0_sizes0_node), properties: this0_sizes0_node},{type: 'Connected', name: 'Product', relationshipName: 'HAS_SIZE', toName: 'Size', id: id(this0), toID: id(this0_sizes0_node)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL AND (metaVal.toID IS NOT NULL OR metaVal.toName IS NULL) ] as this0_mutateMeta
            WITH this0, this0_mutateMeta
            ...
            WITH this0, this0_mutateMeta + [ metaVal IN [{type: 'Created', name: 'Size', id: id(this0_sizes1_node), properties: this0_sizes1_node},{type: 'Connected', name: 'Product', relationshipName: 'HAS_SIZE', toName: 'Size', id: id(this0), toID: id(this0_sizes1_node)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL AND (metaVal.toID IS NOT NULL OR metaVal.toName IS NULL) ] as this0_mutateMeta
            WITH this0, this0_mutateMeta
            ...
            WITH this0, this0_mutateMeta + [ metaVal IN [{type: 'Created', name: 'Color', id: id(this0_colors0_node), properties: this0_colors0_node},{type: 'Connected', name: 'Product', relationshipName: 'HAS_COLOR', toName: 'Color', id: id(this0), toID: id(this0_colors0_node)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL AND (metaVal.toID IS NOT NULL OR metaVal.toName IS NULL) ] as this0_mutateMeta
            WITH this0, this0_mutateMeta
            ...
            WITH this0, this0_mutateMeta + [ metaVal IN [{type: 'Created', name: 'Color', id: id(this0_colors1_node), properties: this0_colors1_node},{type: 'Connected', name: 'Product', relationshipName: 'HAS_COLOR', toName: 'Color', id: id(this0), toID: id(this0_colors1_node)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL AND (metaVal.toID IS NOT NULL OR metaVal.toName IS NULL) ] as this0_mutateMeta
            WITH this0, this0_mutateMeta
            ...
            WITH this0, this0_mutateMeta + [ metaVal IN [{type: 'Created', name: 'Photo', id: id(this0_photos0_node), properties: this0_photos0_node},{type: 'Connected', name: 'Product', relationshipName: 'HAS_PHOTO', toName: 'Photo', id: id(this0), toID: id(this0_photos0_node)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL AND (metaVal.toID IS NOT NULL OR metaVal.toName IS NULL) ] as this0_mutateMeta
            WITH this0, this0_mutateMeta
            ...
            WITH this0, this0_photos1_node, this0_mutateMeta + [ metaVal IN [{type: 'Created', name: 'Photo', id: id(this0_photos1_node), properties: this0_photos1_node}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL AND (metaVal.toID IS NOT NULL OR metaVal.toName IS NULL) ] as this0_mutateMeta
            CALL {
            ...
            WITH this0, this0_mutateMeta + [ metaVal IN [{type: 'Connected', name: 'Product', relationshipName: 'HAS_PHOTO', toName: 'Photo', id: id(this0), toID: id(this0_photos1_node)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL AND (metaVal.toID IS NOT NULL OR metaVal.toName IS NULL) ] as this0_mutateMeta
            WITH this0, this0_mutateMeta
            ...
            WITH this0, this0_photos2_node, this0_mutateMeta + [ metaVal IN [{type: 'Created', name: 'Photo', id: id(this0_photos2_node), properties: this0_photos2_node}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL AND (metaVal.toID IS NOT NULL OR metaVal.toName IS NULL) ] as this0_mutateMeta
            CALL {
            ...
            RETURN this0, this0_photos2_node, this0_photos2_node_color_connect0_node, [ metaVal IN [{type: 'Connected', name: 'Photo', relationshipName: 'OF_COLOR', toName: 'Color', id: id(this0_photos2_node), toID: id(this0_photos2_node_color_connect0_node)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL AND (metaVal.toID IS NOT NULL OR metaVal.toName IS NULL) ] as this0_photos2_node_color_connect0_node_mutateMeta
            ...
            RETURN this0, REDUCE(tmp1_this0_mutateMeta = [], tmp2_this0_mutateMeta IN COLLECT(this0_mutateMeta + [ metaVal IN [{type: 'Connected', name: 'Product', relationshipName: 'HAS_PHOTO', toName: 'Photo', id: id(this0), toID: id(this0_photos2_node)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL AND (metaVal.toID IS NOT NULL OR metaVal.toName IS NULL) ]) | tmp1_this0_mutateMeta + tmp2_this0_mutateMeta) as this0_mutateMeta
            }
    ...
    test("Update Pringles Color", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WITH this, this_photos0, this_has_photo0_relationship, this_photos0_color0_disconnect0, this_photos0_color0_disconnect0_rel, [ metaVal IN [{type: 'Disconnected', name: 'Photo', toName: 'Color', relationshipName: 'OF_COLOR', id: id(this_photos0), toID: id(this_photos0_color0_disconnect0), relationshipID: id(this_photos0_color0_disconnect0_rel)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL AND (metaVal.toID IS NOT NULL OR metaVal.toName IS NULL) ] as this_photos0_mutateMeta
            ...
            RETURN this, this_photos0, this_has_photo0_relationship, mutateMeta + [ metaVal IN [{type: 'Updated', name: 'Photo', id: id(this_photos0), properties: $this_update_photos0}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL AND (metaVal.toID IS NOT NULL OR metaVal.toName IS NULL) ] as mutateMeta
