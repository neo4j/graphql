...
describe("Cypher -> Connections -> Filtering -> Relationship -> Points", () => {
    ...
    test("DISTANCE", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WITH collect({ screenTime: this_acted_in_relationship.screenTime, location: (CASE WHEN this_acted_in_relationship.location IS NOT NULL THEN { point: this_acted_in_relationship.location } ELSE NULL END), node: { name: this_actor.name } }) AS edges
