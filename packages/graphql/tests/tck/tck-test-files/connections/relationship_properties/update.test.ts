...
describe("Cypher -> Connections -> Relationship Properties -> Update", () => {
    ...
    test("Update a relationship property on a relationship between two specified nodes (update -> update)", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            RETURN this, this_actors0, this_acted_in0_relationship, [ metaVal IN [{type: 'RelationshipUpdated', name: 'Movie', relationshipName: 'ACTED_IN', toName: 'Actor', id: id(this), relationshipID: id(this_acted_in0_relationship), toID: id(this_actors0), properties: $updateMovies.args.update.actors[0].update.edge}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL ] as mutateMeta
