...
describe("Cypher Auth Allow", () => {
    ...
    test("Create Nested Node", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WITH this0, this0_contentPost0_node
            CALL apoc.util.validate(NOT ((exists((:\`User\`)-[:HAS_CONTENT]->(this0_contentPost0_node)) AND all(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this0_contentPost0_node) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this0_contentPost0_node_auth_bind0_creator_id)))), \\"@neo4j/graphql/FORBIDDEN\\", [0])
    ...
    test("Connect Node", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
            	...
            	CALL apoc.util.validate(NOT ((this_connect_content0_node.id IS NOT NULL AND this_connect_content0_node.id = $this_connect_content0_nodeUser0_bind_auth_bind0_id) AND (exists((:\`User\`)-[:HAS_CONTENT]->(this_connect_content0_node)) AND all(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this_connect_content0_node) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_connect_content0_nodeComment1_bind_auth_bind0_creator_id)))), \\"@neo4j/graphql/FORBIDDEN\\", [0])
            	RETURN count(*) AS _
            UNION
            	WITH this
            	...
            	WITH this, this_connect_content0_node
            	CALL apoc.util.validate(NOT ((this_connect_content0_node.id IS NOT NULL AND this_connect_content0_node.id = $this_connect_content0_nodeUser0_bind_auth_bind0_id) AND (exists((:\`User\`)-[:HAS_CONTENT]->(this_connect_content0_node)) AND all(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this_connect_content0_node) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_connect_content0_nodePost1_bind_auth_bind0_creator_id)))), \\"@neo4j/graphql/FORBIDDEN\\", [0])
            	RETURN count(*) AS _
            }
            RETURN collect(DISTINCT this { .id }) AS data"
        `);
    ...
    test("Disconnect Node", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL apoc.util.validate(NOT ((this_disconnect_content0.id IS NOT NULL AND this_disconnect_content0.id = $this_disconnect_content0User0_bind_auth_bind0_id) AND (exists((:\`User\`)-[:HAS_CONTENT]->(this_disconnect_content0)) AND all(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this_disconnect_content0) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_disconnect_content0Comment1_bind_auth_bind0_creator_id)))), \\"@neo4j/graphql/FORBIDDEN\\", [0])
            RETURN count(*) AS _
            UNION
            WITH this
            ...
            WITH this, this_disconnect_content0
            CALL apoc.util.validate(NOT ((this_disconnect_content0.id IS NOT NULL AND this_disconnect_content0.id = $this_disconnect_content0User0_bind_auth_bind0_id) AND (exists((:\`User\`)-[:HAS_CONTENT]->(this_disconnect_content0)) AND all(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this_disconnect_content0) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_disconnect_content0Post1_bind_auth_bind0_creator_id)))), \\"@neo4j/graphql/FORBIDDEN\\", [0])
            RETURN count(*) AS _
            }
            RETURN collect(DISTINCT this { .id }) AS data"
        `);
