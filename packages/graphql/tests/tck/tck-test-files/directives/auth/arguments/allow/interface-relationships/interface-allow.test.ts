...
describe("@auth allow with interface relationships", () => {
    ...
    test("read allow protected interface relationship", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL apoc.util.validate(NOT ((exists((:\`User\`)-[:HAS_CONTENT]->(this_Comment)) AND any(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this_Comment) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_Comment_auth_allow0_creator_id)))), \\"@neo4j/graphql/FORBIDDEN\\", [0])
            ...
            CALL apoc.util.validate(NOT ((exists((:\`User\`)-[:HAS_CONTENT]->(this_Post)) AND any(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this_Post) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_Post_auth_allow0_creator_id)))), \\"@neo4j/graphql/FORBIDDEN\\", [0])
    ...
    test("Read Two Relationships", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            RETURN { __resolveType: \\"Post\\", comments: [ (this_Post)-[:HAS_COMMENT]->(this_Post_comments:Comment)  WHERE this_Post_comments.id = $this_Post_comments_param0 AND apoc.util.validatePredicate(NOT ((exists((:\`User\`)-[:HAS_CONTENT]->(this_Post_comments)) AND any(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this_Post_comments) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_Post_comments_auth_allow0_creator_id)))), \\"@neo4j/graphql/FORBIDDEN\\", [0]) | this_Post_comments { .content } ] } AS content
            }
            RETURN collect(content) AS content
            }
            RETURN this { .id, content: content } as this"
    ...
    test("Nested Update Node", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL apoc.util.validate(NOT ((exists((:\`User\`)-[:HAS_CONTENT]->(this_content0)) AND any(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this_content0) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_content0_auth_allow0_creator_id)))), \\\\\\"@neo4j/graphql/FORBIDDEN\\\\\\", [0])
    ...
    test("Nested Update Property", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WHERE this.id = $param0
            WITH this
            CALL apoc.util.validate(NOT ((exists((:\`User\`)-[:HAS_CONTENT]->(this)) AND any(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_auth_allow0_creator_id)))), \\"@neo4j/graphql/FORBIDDEN\\", [0])
            WITH this
    ...
    test("Nested Delete Node", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL apoc.util.validate(NOT ((exists((:\`User\`)-[:HAS_CONTENT]->(this_content_Comment0)) AND any(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this_content_Comment0) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_content_Comment0_auth_allow0_creator_id)))), \\"@neo4j/graphql/FORBIDDEN\\", [0])
            ...
            CALL apoc.util.validate(NOT ((exists((:\`User\`)-[:HAS_CONTENT]->(this_content_Post0)) AND any(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this_content_Post0) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_content_Post0_auth_allow0_creator_id)))), \\"@neo4j/graphql/FORBIDDEN\\", [0])
    ...
    test("Disconnect Node", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL apoc.util.validate(NOT ((this.id IS NOT NULL AND this.id = $thisUser0_allow_auth_allow0_id) AND (exists((:\`User\`)-[:HAS_CONTENT]->(this_disconnect_content0)) AND any(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this_disconnect_content0) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_disconnect_content0Comment1_allow_auth_allow0_creator_id)))), \\"@neo4j/graphql/FORBIDDEN\\", [0])
            ...
            WHERE this_disconnect_content0.id = $updateUsers.args.disconnect.content[0].where.node.id
            WITH this, this_disconnect_content0, this_disconnect_content0_rel
            CALL apoc.util.validate(NOT ((this.id IS NOT NULL AND this.id = $thisUser0_allow_auth_allow0_id) AND (exists((:\`User\`)-[:HAS_CONTENT]->(this_disconnect_content0)) AND any(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this_disconnect_content0) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_disconnect_content0Post1_allow_auth_allow0_creator_id)))), \\"@neo4j/graphql/FORBIDDEN\\", [0])
            FOREACH(_ IN CASE WHEN this_disconnect_content0 IS NULL THEN [] ELSE [1] END |
            DELETE this_disconnect_content0_rel
            )
            RETURN count(*) AS _
    ...
    test("Nested Disconnect Node", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL apoc.util.validate(NOT ((exists((:\`User\`)-[:HAS_CONTENT]->(this_disconnect_content0)) AND any(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this_disconnect_content0) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_disconnect_content0Post0_allow_auth_allow0_creator_id))) AND (exists((:\`User\`)-[:HAS_CONTENT]->(this_disconnect_content0_comments0)) AND any(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this_disconnect_content0_comments0) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_disconnect_content0_comments0Comment1_allow_auth_allow0_creator_id)))), \\"@neo4j/graphql/FORBIDDEN\\", [0])
    ...
    test("Connect Node", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
            	...
            	CALL apoc.util.validate(NOT ((exists((:\`User\`)-[:HAS_CONTENT]->(this_connect_content0_node)) AND any(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this_connect_content0_node) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_connect_content0_nodeComment0_allow_auth_allow0_creator_id))) AND (this.id IS NOT NULL AND this.id = $thisUser1_allow_auth_allow0_id)), \\"@neo4j/graphql/FORBIDDEN\\", [0])
            ...
            UNION
            	...
            	WHERE this_connect_content0_node.id = $this_connect_content0_node_param0
            	WITH this, this_connect_content0_node
            	CALL apoc.util.validate(NOT ((exists((:\`User\`)-[:HAS_CONTENT]->(this_connect_content0_node)) AND any(creator IN [(creator:\`User\`)-[:HAS_CONTENT]->(this_connect_content0_node) | creator] WHERE (creator.id IS NOT NULL AND creator.id = $this_connect_content0_nodePost0_allow_auth_allow0_creator_id))) AND (this.id IS NOT NULL AND this.id = $thisUser1_allow_auth_allow0_id)), \\"@neo4j/graphql/FORBIDDEN\\", [0])
            	FOREACH(_ IN CASE WHEN this IS NULL THEN [] ELSE [1] END |
            		FOREACH(_ IN CASE WHEN this_connect_content0_node IS NULL THEN [] ELSE [1] END |
            			MERGE (this)-[:HAS_CONTENT]->(this_connect_content0_node)
            		)
