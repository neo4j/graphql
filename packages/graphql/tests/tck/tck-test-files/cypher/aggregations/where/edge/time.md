...
WHERE apoc.cypher.runFirstColumn("
    ...
    { this: this, this_likesAggregate_edge_someTime_MIN_EQUAL: $this_likesAggregate_edge_someTime_MIN_EQUAL },
    false
)
RETURN this { .content } as this
```
...
WHERE apoc.cypher.runFirstColumn("
    ...
    { this: this, this_likesAggregate_edge_someTime_MIN_GT: $this_likesAggregate_edge_someTime_MIN_GT },
    false
)
RETURN this { .content } as this
```
...
WHERE apoc.cypher.runFirstColumn("
    ...
    { this: this, this_likesAggregate_edge_someTime_MIN_GTE: $this_likesAggregate_edge_someTime_MIN_GTE },
    false
)
RETURN this { .content } as this
```
...
WHERE apoc.cypher.runFirstColumn("
    ...
    { this: this, this_likesAggregate_edge_someTime_MIN_LT: $this_likesAggregate_edge_someTime_MIN_LT },
    false
)
RETURN this { .content } as this
```
...
WHERE apoc.cypher.runFirstColumn("
    ...
    { this: this, this_likesAggregate_edge_someTime_MIN_LTE: $this_likesAggregate_edge_someTime_MIN_LTE },
    false
)
RETURN this { .content } as this
```
...
WHERE apoc.cypher.runFirstColumn("
    ...
    { this: this, this_likesAggregate_edge_someTime_MAX_EQUAL: $this_likesAggregate_edge_someTime_MAX_EQUAL },
    false
)
RETURN this { .content } as this
```
...
WHERE apoc.cypher.runFirstColumn("
    ...
    { this: this, this_likesAggregate_edge_someTime_MAX_GT: $this_likesAggregate_edge_someTime_MAX_GT },
    false
)
RETURN this { .content } as this
```
...
WHERE apoc.cypher.runFirstColumn("
    ...
    { this: this, this_likesAggregate_edge_someTime_MAX_GTE: $this_likesAggregate_edge_someTime_MAX_GTE },
    false
)
RETURN this { .content } as this
```
...
WHERE apoc.cypher.runFirstColumn("
    ...
    { this: this, this_likesAggregate_edge_someTime_MAX_LT: $this_likesAggregate_edge_someTime_MAX_LT },
    false
)
RETURN this { .content } as this
```
...
WHERE apoc.cypher.runFirstColumn("
    ...
    { this: this, this_likesAggregate_edge_someTime_MAX_LTE: $this_likesAggregate_edge_someTime_MAX_LTE },
    false
)
RETURN this { .content } as this
```
