...
describe("Index issues reported in Trello", () => {
    ...
    test("Filter generated by query doesn't utilise index", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WHERE exists((this)-[:dcterms__title]->(:\`dcterms_title\`:\`property\`)) AND any(this_dcterms__title IN [(this)-[:dcterms__title]->(this_dcterms__title:\`dcterms_title\`:\`property\`) | this_dcterms__title] WHERE this_dcterms__title.value CONTAINS $this_dcterms__title_value_CONTAINS)
