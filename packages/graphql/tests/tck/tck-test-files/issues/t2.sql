    ...
    CALL {
        ...
        CALL {
            ...
            CALL apoc.util.validate(NOT((ANY(r IN [\\"admin\\"]
                ...
                // THIS HERE // WHERE this_drivecomposition_has_relationship.current = $this_driveCompositionsConnection.edges.node.driveComponentConnection.args.where.Battery.edge.current
