    ...
    test("Example 1", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                WITH this_documents { customerContactConnection: apoc.cypher.runFirstColumnSingle(\\"CALL {
                WITH this_documents
                ...
                } RETURN customerContactConnection\\", { this_documents: this_documents, auth: $auth }) } AS this_documents
