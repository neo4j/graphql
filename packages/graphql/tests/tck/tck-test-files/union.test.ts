...
describe("Cypher Union", () => {
    ...
    test("Create Unions from create mutation", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            RETURN this0, REDUCE(tmp1_this0_mutateMeta = [], tmp2_this0_mutateMeta IN COLLECT(this0_mutateMeta + [ metaVal IN [{type: 'Created', name: 'Genre', id: id(this0_search_Genre0_node), properties: this0_search_Genre0_node}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL ]) | tmp1_this0_mutateMeta + tmp2_this0_mutateMeta) as this0_mutateMeta
            }
    ...
    test("Create Unions from update create(top-level)", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WITH this, this_create_search_Genre0_node, [ metaVal IN [{type: 'Created', name: 'Genre', id: id(this_create_search_Genre0_node), properties: this_create_search_Genre0_node}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL ] as mutateMeta
            MERGE (this)-[:SEARCH]->(this_create_search_Genre0_node)
            WITH this, mutateMeta + [ metaVal IN [{type: 'Connected', name: 'Movie', toName: 'Genre', relationshipName: 'SEARCH', id: id(this_create_search_Genre0_node), toID: id(this)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL ] as mutateMeta
    ...
    test("Connect Unions (in create)", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            RETURN this0, this0_search_Genre_connect0_node, [ metaVal IN [{type: 'Connected', name: 'Movie', relationshipName: 'SEARCH', toName: 'Genre', id: id(this0), toID: id(this0_search_Genre_connect0_node)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL ] as this0_search_Genre_connect0_node_mutateMeta
    ...
    test("Update Unions", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            RETURN this, this_search_Genre0, this_search0_relationship, [ metaVal IN [{type: 'Updated', name: 'Genre', id: id(this_search_Genre0), properties: $this_update_search_Genre0}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL ] as mutateMeta
    ...
    test("Disconnect Unions", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WITH this, this_disconnect_search_Genre0, this_disconnect_search_Genre0_rel, [ metaVal IN [{type: 'Disconnected', name: 'Movie', toName: 'Genre', relationshipName: 'SEARCH', id: id(this), toID: id(this_disconnect_search_Genre0), relationshipID: id(this_disconnect_search_Genre0_rel)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL ] as this_mutateMeta
    ...
    test("Connect Unions (in update)", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            RETURN this, this_connect_search_Genre0_node, [ metaVal IN [{type: 'Connected', name: 'Movie', relationshipName: 'SEARCH', toName: 'Genre', id: id(this), toID: id(this_connect_search_Genre0_node)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL ] as this_connect_search_Genre0_node_mutateMeta
    ...
    test("Delete Unions (from update)", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WITH this, this_delete_search_Genre0, collect(DISTINCT this_delete_search_Genre0) as this_delete_search_Genre0_to_delete, [ metaVal IN [{type: 'Deleted', name: 'Genre', id: id(this_delete_search_Genre0)}] WHERE metaVal IS NOT NULL AND metaVal.id IS NOT NULL ] as mutateMeta
