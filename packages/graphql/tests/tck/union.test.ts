        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                CALL {
                    ...
                    WITH this_search { __resolveType: \\"Genre\\", .name, __id: id(this) } AS this_search
                    RETURN this_search AS this_search
                    UNION
                    WITH *
                    MATCH (this)-[this1:SEARCH]->(this_search:\`Movie\`)
                    WITH this_search { __resolveType: \\"Movie\\", .title, __id: id(this) } AS this_search
                    RETURN this_search AS this_search
                }
                WITH this_search
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                CALL {
                    ...
                    WITH *
                    MATCH (this)-[this1:SEARCH]->(this_search:\`Movie\`)
                    WITH this_search { __resolveType: \\"Movie\\", __id: id(this) } AS this_search
                    RETURN this_search AS this_search
                }
                WITH this_search
                RETURN collect(this_search) AS this_search
