                ...
                describe("nested mutations", () => {
                    test("should add validation when deleting a required relationship", async () => {
                        ...
                        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
                            ...
                            WITH *
                            CALL {
                            WITH this, this_delete_director0, this_delete_director0_relationship
                            ...
                            RETURN count(*) AS _this_delete_director0_address0_relationship
                            }
                            ...
                            RETURN count(*) AS _this_delete_director0_relationship
                            }
                            WITH *
                            WITH *
                            CALL {
