...
describe("Cypher Aggregations where node with LocalTime", () => {
    ...
    test("EQUAL with alias", async () => {
        ...
        expect(formatParams(result.params)).toMatchInlineSnapshot(`
            "{
                \\"aggr_node_someLocalTimeAlias_EQUAL\\": {
                    \\"hour\\": 12,
                    \\"minute\\": 0,
                    \\"second\\": 0,
                    \\"nanosecond\\": 0
    ...
    test("MIN_EQUAL", async () => {
        ...
        expect(formatParams(result.params)).toMatchInlineSnapshot(`
            "{
                \\"aggr_node_someLocalTime_MIN_EQUAL\\": {
                    \\"hour\\": 12,
                    \\"minute\\": 0,
                    \\"second\\": 0,
                    \\"nanosecond\\": 0
    ...
    test("MIN_GT", async () => {
        ...
        expect(formatParams(result.params)).toMatchInlineSnapshot(`
            "{
                \\"aggr_node_someLocalTime_MIN_GT\\": {
                    \\"hour\\": 12,
                    \\"minute\\": 0,
                    \\"second\\": 0,
                    \\"nanosecond\\": 0
    ...
    test("MIN_GTE", async () => {
        ...
        expect(formatParams(result.params)).toMatchInlineSnapshot(`
            "{
                \\"aggr_node_someLocalTime_MIN_GTE\\": {
                    \\"hour\\": 12,
                    \\"minute\\": 0,
                    \\"second\\": 0,
                    \\"nanosecond\\": 0
    ...
    test("MIN_LT", async () => {
        ...
        expect(formatParams(result.params)).toMatchInlineSnapshot(`
            "{
                \\"aggr_node_someLocalTime_MIN_LT\\": {
                    \\"hour\\": 12,
                    \\"minute\\": 0,
                    \\"second\\": 0,
                    \\"nanosecond\\": 0
    ...
    test("MIN_LTE", async () => {
        ...
        expect(formatParams(result.params)).toMatchInlineSnapshot(`
            "{
                \\"aggr_node_someLocalTime_MIN_LTE\\": {
                    \\"hour\\": 12,
                    \\"minute\\": 0,
                    \\"second\\": 0,
                    \\"nanosecond\\": 0
    ...
    test("MAX_EQUAL", async () => {
        ...
        expect(formatParams(result.params)).toMatchInlineSnapshot(`
            "{
                \\"aggr_node_someLocalTime_MAX_EQUAL\\": {
                    \\"hour\\": 12,
                    \\"minute\\": 0,
                    \\"second\\": 0,
                    \\"nanosecond\\": 0
    ...
    test("MAX_GT", async () => {
        ...
        expect(formatParams(result.params)).toMatchInlineSnapshot(`
            "{
                \\"aggr_node_someLocalTime_MAX_GT\\": {
                    \\"hour\\": 12,
                    \\"minute\\": 0,
                    \\"second\\": 0,
                    \\"nanosecond\\": 0
    ...
    test("MAX_GTE", async () => {
        ...
        expect(formatParams(result.params)).toMatchInlineSnapshot(`
            "{
                \\"aggr_node_someLocalTime_MAX_GTE\\": {
                    \\"hour\\": 12,
                    \\"minute\\": 0,
                    \\"second\\": 0,
                    \\"nanosecond\\": 0
    ...
    test("MAX_LT", async () => {
        ...
        expect(formatParams(result.params)).toMatchInlineSnapshot(`
            "{
                \\"aggr_node_someLocalTime_MAX_LT\\": {
                    \\"hour\\": 12,
                    \\"minute\\": 0,
                    \\"second\\": 0,
                    \\"nanosecond\\": 0
    ...
    test("MAX_LTE", async () => {
        ...
        expect(formatParams(result.params)).toMatchInlineSnapshot(`
            "{
                \\"aggr_node_someLocalTime_MAX_LTE\\": {
                    \\"hour\\": 12,
                    \\"minute\\": 0,
                    \\"second\\": 0,
                    \\"nanosecond\\": 0
