        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                CALL {
                    ...
                    WITH this0_workers { __resolveType: \\"Actor\\", .name, __id: id(this0) } AS this0_workers
                    RETURN this0_workers AS this0_workers
                    UNION
                    WITH *
                    MATCH (this0)<-[create_this1:EMPLOYED]-(this0_workers:\`Modeler\`)
                    WITH this0_workers { __resolveType: \\"Modeler\\", .name, __id: id(this0) } AS this0_workers
                    RETURN this0_workers AS this0_workers
                }
                WITH this0_workers
            ...
            CALL {
                ...
                CALL {
                    ...
                    WITH this1_workers { __resolveType: \\"Actor\\", .name, __id: id(this1) } AS this1_workers
                    RETURN this1_workers AS this1_workers
                    UNION
                    WITH *
                    MATCH (this1)<-[create_this1:EMPLOYED]-(this1_workers:\`Modeler\`)
                    WITH this1_workers { __resolveType: \\"Modeler\\", .name, __id: id(this1) } AS this1_workers
                    RETURN this1_workers AS this1_workers
                }
                WITH this1_workers
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                CALL {
                    ...
                    WITH this2_workers { __resolveType: \\"Actor\\", .name, __id: id(this2) } AS this2_workers
                    RETURN this2_workers AS this2_workers
                    UNION
                    WITH *
                    MATCH (this2)<-[create_this2:EMPLOYED]-(this2_workers:\`Modeler\`)
                    WITH this2_workers { __resolveType: \\"Modeler\\", .name, __id: id(this2) } AS this2_workers
                    RETURN this2_workers AS this2_workers
                }
                WITH this2_workers
            ...
            CALL {
                ...
                CALL {
                    ...
                    WITH this3_workers { __resolveType: \\"Actor\\", .name, __id: id(this3) } AS this3_workers
                    RETURN this3_workers AS this3_workers
                    UNION
                    WITH *
                    MATCH (this3)<-[create_this2:EMPLOYED]-(this3_workers:\`Modeler\`)
                    WITH this3_workers { __resolveType: \\"Modeler\\", .name, __id: id(this3) } AS this3_workers
                    RETURN this3_workers AS this3_workers
                }
                WITH this3_workers
