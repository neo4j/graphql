    ...
    test("DateTime and Point fields are included in onCreate", async () => {
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            input ActorWhere {
              ...
              dob_LT: DateTime
              dob_LTE: DateTime
              dob_NOT: DateTime @deprecated(reason: \\"Use \`actorsConnection_NONE\` instead.\\")
              dob_NOT_IN: [DateTime!] @deprecated(reason: \\"Use \`actorsConnection_NONE\` instead.\\")
              homeAddress: PointInput
              ...
              homeAddress_NOT: PointInput @deprecated(reason: \\"Use \`actorsConnection_NONE\` instead.\\")
              homeAddress_NOT_IN: [PointInput!] @deprecated(reason: \\"Use \`actorsConnection_NONE\` instead.\\")
              id: ID
              id_CONTAINS: ID
              id_ENDS_WITH: ID
              id_IN: [ID!]
