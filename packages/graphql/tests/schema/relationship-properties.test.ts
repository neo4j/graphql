    ...
    test("Relationship Properties", async () => {
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            input ActedInWhere {
              ...
              OR: [ActedInWhere!]
              leadRole: Boolean
              leadRole_NOT: Boolean @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
              screenTime: Int
              screenTime_GT: Int
              screenTime_GTE: Int
              screenTime_IN: [Int!]
              ...
              startDate_LT: Date
              startDate_LTE: Date
              startDate_NOT: Date @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
              startDate_NOT_IN: [Date!] @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
            }
    ...
    test("should filter out generated fields", async () => {
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            input ActedInWhere {
              ...
              timestamp_NOT: DateTime @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
              timestamp_NOT_IN: [DateTime!] @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
            }
