    ...
    test("CartesianPoint", async () => {
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            input MachineWhere {
              ...
              partLocation_NOT: CartesianPointInput @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
              partLocation_NOT_IN: [CartesianPointInput!] @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
            }
    ...
    test("Points", async () => {
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            input MovieWhere {
              ...
              filmedAt_NOT: [PointInput!] @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
              filmedAt_NOT_INCLUDES: PointInput @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
            }
    ...
    test("CartesianPoints", async () => {
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            input MachineWhere {
              ...
              partLocations_NOT: [CartesianPointInput!] @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
              partLocations_NOT_INCLUDES: CartesianPointInput @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
            }
