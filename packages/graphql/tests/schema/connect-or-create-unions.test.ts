    ...
    test("With Unions", async () => {
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            input MovieWhere {
              ...
              isan_IN: [String!]
              isan_NOT: String @deprecated(reason: \\"Use \`actedInConnection_NONE\` instead.\\")
              isan_NOT_CONTAINS: String @deprecated(reason: \\"Use \`actedInConnection_NONE\` instead.\\")
              isan_NOT_ENDS_WITH: String @deprecated(reason: \\"Use \`actedInConnection_NONE\` instead.\\")
              isan_NOT_IN: [String!] @deprecated(reason: \\"Use \`actedInConnection_NONE\` instead.\\")
              isan_NOT_STARTS_WITH: String @deprecated(reason: \\"Use \`actedInConnection_NONE\` instead.\\")
