    ...
    test("Operators should be presents in nested updates", async () => {
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            input DirectorWhere {
              ...
              lastName_IN: [String!]
              lastName_NOT: String @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
              lastName_NOT_CONTAINS: String @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
              lastName_NOT_ENDS_WITH: String @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
              lastName_NOT_IN: [String!] @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
              lastName_NOT_STARTS_WITH: String @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
            ...
            input MovieDirectedByConnectionWhere {
              ...
              node: DirectorWhere
              node_NOT: DirectorWhere @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
            }
    ...
    test("Should be supported in interfaces", async () => {
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            input MovieWorkersConnectionWhere {
              ...
              node: PersonWhere
              node_NOT: PersonWhere @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
            }
    ...
    test("Should be supported in Relationship properties", async () => {
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            input ActedInWhere {
              ...
              pay_LT: Float
              pay_LTE: Float
              pay_NOT: Float @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
              pay_NOT_IN: [Float] @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
              roles: [String!]
              roles_INCLUDES: String
              roles_NOT: [String!] @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
              roles_NOT_INCLUDES: String @deprecated(reason: \\"Negate filters will be deprecated from version 4.0.0, use the NOT operator to achieve the same behavior\\")
            }
