        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            * UntrainedPerson.actedIn
            ...
            input UntrainedPersonActedInAggregateInput {
              ...
              count_LT: Int
              count_LTE: Int
              edge: UntrainedPersonActedInEdgeAggregationWhereInput
            ...
            input UntrainedPersonActedInEdgeAggregationWhereInput {
              AND: [UntrainedPersonActedInEdgeAggregationWhereInput!]
              NOT: UntrainedPersonActedInEdgeAggregationWhereInput
              OR: [UntrainedPersonActedInEdgeAggregationWhereInput!]
