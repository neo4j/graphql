...
describe("https://github.com/neo4j/graphql/issues/3439", () => {
    ...
    test("Simple type definitions implementing just one interface with different relationship properties", async () => {
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
                    ...
                    type MovieEventPayload implements IProductEventPayload {
                      genre: Genre!
                      genreConnection: IProductGenreConnection!
                      id: String!
                      name: String!
                    }
                    ...
                    \\"\\"\\"Type describing relationship properties for the Movie.genre field.\\"\\"\\"
                    type MovieProps {
                      year: Int!
                    }
                    ...
                    \\"\\"\\"Type describing relationship properties for the Series.genre field.\\"\\"\\"
                    type SeriesProps {
                      episodes: Int
                    }
