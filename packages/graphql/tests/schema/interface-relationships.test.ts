...
describe("Interface Relationships", () => {
    ...
    test("Interface Relationships - no aggregation where fields on edge properties", async () => {
        const typeDefs = gql`
            interface Show {
                title: String!
                actors: [Actor!]! @declareRelationship
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            * Movie.actors
            ...
            input ActedInUpdateInput {
              screenTime: ListIntMutations
              screenTime_POP: Int @deprecated(reason: \\"Please use the generic mutation 'screenTime: { pop: ... } }' instead.\\")
              screenTime_PUSH: [Int!] @deprecated(reason: \\"Please use the generic mutation 'screenTime: { push: ... } }' instead.\\")
              screenTime_SET: [Int!] @deprecated(reason: \\"Please use the generic mutation 'screenTime: { set: ... } }' instead.\\")
            }
            ...
            input ActedInWhere {
              ...
              NOT: ActedInWhere
              OR: [ActedInWhere!]
              screenTime: IntListFilters
              screenTime_EQ: [Int!] @deprecated(reason: \\"Please use the relevant generic filter screenTime: { eq: ... }\\")
              screenTime_INCLUDES: Int @deprecated(reason: \\"Please use the relevant generic filter screenTime: { includes: ... }\\")
            }
