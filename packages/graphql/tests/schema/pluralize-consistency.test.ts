    ...
    test("Schema with underscore types", async () => {
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            input super_friendWhere {
              ...
              name_IN: [String!]
              name_NOT: String @deprecated(reason: \\"Use \`my_friendConnection_NONE\` instead.\\")
              name_NOT_CONTAINS: String @deprecated(reason: \\"Use \`my_friendConnection_NONE\` instead.\\")
              name_NOT_ENDS_WITH: String @deprecated(reason: \\"Use \`my_friendConnection_NONE\` instead.\\")
              name_NOT_IN: [String!] @deprecated(reason: \\"Use \`my_friendConnection_NONE\` instead.\\")
              name_NOT_STARTS_WITH: String @deprecated(reason: \\"Use \`my_friendConnection_NONE\` instead.\\")
            ...
            input super_userMy_friendConnectionWhere {
              ...
              node: super_friendWhere
              node_NOT: super_friendWhere @deprecated(reason: \\"Use \`my_friendConnection_NONE\` instead.\\")
            }
