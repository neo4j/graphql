    ...
    test("Schema with underscore types", async () => {
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            input super_userWhere {
              ...
              \\"\\"\\"
              Return super_users where all of the related my_friendConnections match this filter
              \\"\\"\\"
              my_friendConnection_ALL: super_userMy_friendConnectionWhere
              \\"\\"\\"
              Return super_users where none of the related my_friendConnections match this filter
              \\"\\"\\"
              ...
              \\"\\"\\"
              Return super_users where one of the related my_friendConnections match this filter
              \\"\\"\\"
              my_friendConnection_SINGLE: super_userMy_friendConnectionWhere
              \\"\\"\\"
              Return super_users where some of the related my_friendConnections match this filter
              \\"\\"\\"
              my_friendConnection_SOME: super_userMy_friendConnectionWhere
              \\"\\"\\"
              Return super_users where all of the related my_friends match this filter
              \\"\\"\\"
              my_friend_ALL: super_friendWhere
              \\"\\"\\"
              Return super_users where none of the related my_friends match this filter
              \\"\\"\\"
              my_friend_NONE: super_friendWhere
              my_friend_NOT: super_friendWhere @deprecated(reason: \\"Use \`my_friend_NONE\` instead.\\")
              \\"\\"\\"
              Return super_users where one of the related my_friends match this filter
              \\"\\"\\"
              my_friend_SINGLE: super_friendWhere
              \\"\\"\\"
              Return super_users where some of the related my_friends match this filter
              \\"\\"\\"
