    ...
    test("should exclude suffix based filtering", async () => {
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            input interfaceCWhere {
              ...
              cartesianPoint_DISTANCE: CartesianPointDistance
              cartesianPoint_EQ: CartesianPointInput
              cartesianPoint_GT: CartesianPointDistance
              cartesianPoint_GTE: CartesianPointDistance
              cartesianPoint_IN: [CartesianPointInput]
              cartesianPoint_LT: CartesianPointDistance
              cartesianPoint_LTE: CartesianPointDistance
              ...
              list_EQ: [String!]
              list_INCLUDES: String
              localDateTime: LocalDateTimeScalarFilters
              localDateTime_EQ: LocalDateTime
              localDateTime_GT: LocalDateTime
              localDateTime_GTE: LocalDateTime
              localDateTime_IN: [LocalDateTime]
              localDateTime_LT: LocalDateTime
              localDateTime_LTE: LocalDateTime
              localTime: LocalTimeScalarFilters
              localTime_EQ: LocalTime
              localTime_GT: LocalTime
              localTime_GTE: LocalTime
              localTime_IN: [LocalTime]
              localTime_LT: LocalTime
              localTime_LTE: LocalTime
              point: PointFilters
