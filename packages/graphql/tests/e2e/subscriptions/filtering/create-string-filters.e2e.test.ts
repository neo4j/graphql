...
describe("Create Subscription with filters valid on string types (String, ID)", () => {
    ...
    test("subscription with where filter NOT STARTS_WITH for String", async () => {
        await wsClient.subscribe(`
        subscription {
            ${typeMovie.operations.subscribe.created}(where: { NOT: { title_STARTS_WITH: "movie" } }) {
                ${typeMovie.operations.subscribe.payload.created} {
                    title
                }
            }
    ...
    test("subscription with where filter NOT STARTS_WITH for ID as String", async () => {
        await wsClient.subscribe(`
        subscription {
            ${typeMovie.operations.subscribe.created}(where: { NOT: { id_STARTS_WITH: "dummy" }}) {
                ${typeMovie.operations.subscribe.payload.created} {
                    id
                }
            }
    ...
    test("subscription with where filter NOT STARTS_WITH for ID as Int", async () => {
        await wsClient.subscribe(`
        subscription {
            ${typeMovie.operations.subscribe.created}(where: { NOT: { id_STARTS_WITH: 3 } }) {
                ${typeMovie.operations.subscribe.payload.created} {
                    id
                }
            }
    ...
    test("subscription with where filter NOT ENDS_WITH for String", async () => {
        await wsClient.subscribe(`
        subscription {
            ${typeMovie.operations.subscribe.created}(where: { NOT: { title_ENDS_WITH: "movie1" } }) {
                ${typeMovie.operations.subscribe.payload.created} {
                    title
                }
            }
    ...
    test("subscription with where filter NOT ENDS_WITH for ID as String", async () => {
        await wsClient.subscribe(`
        subscription {
            ${typeMovie.operations.subscribe.created}(where: { NOT: { id_ENDS_WITH: "dummy" } }) {
                ${typeMovie.operations.subscribe.payload.created} {
                    id
                }
            }
    ...
    test("subscription with where filter NOT ENDS_WITH for ID as Int", async () => {
        await wsClient.subscribe(`
        subscription {
            ${typeMovie.operations.subscribe.created}(where: { NOT: { id_ENDS_WITH: 3 }}) {
                ${typeMovie.operations.subscribe.payload.created} {
                    id
                }
            }
    ...
    test("subscription with where filter NOT CONTAINS for String", async () => {
        await wsClient.subscribe(`
        subscription {
            ${typeMovie.operations.subscribe.created}(where: { NOT: { title_CONTAINS: "movie1" } }) {
                ${typeMovie.operations.subscribe.payload.created} {
                    title
                }
            }
    ...
    test("subscription with where filter NOT CONTAINS for ID as String", async () => {
        await wsClient.subscribe(`
        subscription {
            ${typeMovie.operations.subscribe.created}(where: { NOT: { id_CONTAINS: "dummy" }}) {
                ${typeMovie.operations.subscribe.payload.created} {
                    id
                }
            }
    ...
    test("subscription with where filter NOT CONTAINS for ID as Int", async () => {
        await wsClient.subscribe(`
        subscription {
            ${typeMovie.operations.subscribe.created}(where: { NOT: { id_CONTAINS: 3 } }) {
                ${typeMovie.operations.subscribe.payload.created} {
                    id
                }
            }
