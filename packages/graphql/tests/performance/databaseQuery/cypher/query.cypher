...
WITH
  collect(this_actors_movies_actors {.name}) AS this_actors_movies_actors,
  this_actors_movies,
  this_actors,
  this
WITH
  collect(this_actors_movies {.title, actors: this_actors_movies_actors}) AS this_actors_movies,
  this_actors,
  this
WITH
  collect(this_actors {.name, movies: this_actors_movies}) AS this_actors,
  this
...
MATCH
  (this:`Movie`)<-[this0:ACTED_IN]-
  (this_actors:`Person`)-[this1:ACTED_IN]->
  (this_actors_movies:`Movie`)<-[this2:ACTED_IN]-
  (this_actors_movies_actors:`Person`)
WITH
  collect(this_actors_movies_actors {.name}) AS this_actors_movies_actors,
  this_actors_movies,
  this_actors,
