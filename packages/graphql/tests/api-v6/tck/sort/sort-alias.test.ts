    ...
    test("Top-Level sort", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                WITH *
                ORDER BY this0.movieTitle DESC
                RETURN collect({ node: { title: this0.movieTitle, __resolveType: \\"Movie\\" } }) AS var1
            }
    ...
    test("Top-Level multiple sort fields", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                WITH edge.node AS this0
                WITH *
                ORDER BY this0.movieTitle DESC, this0.movieRatings DESC
                RETURN collect({ node: { title: this0.movieTitle, __resolveType: \\"Movie\\" } }) AS var1
            }
            RETURN { connection: { edges: var1, totalCount: totalCount } } AS this"
        `);
