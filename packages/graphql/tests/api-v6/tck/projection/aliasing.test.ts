...
describe("Aliasing", () => {
    ...
    test("should query relationship properties with aliased fields", async () => {
        const query = /* GraphQL */ `
            query {
                myMovies: movies {
                    connection {
            ...
            CALL {
                ...
                CALL {
                    ...
                    CALL {
                        ...
                        RETURN collect({ properties: { releaseYear: this1.year }, node: { __id: id(actors), __resolveType: \\"Actor\\" } }) AS var2
                    }
                    RETURN { connection: { edges: var2, totalCount: totalCount } } AS var3
                }
                RETURN collect({ node: { movieTitle: this0.title, actors: var3, __resolveType: \\"Movie\\" } }) AS var4
            }
