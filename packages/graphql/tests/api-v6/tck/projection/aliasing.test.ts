            ...
            CALL {
                ...
                CALL {
                    ...
                    CALL {
                        ...
                        RETURN collect({ properties: { releaseYear: this1.year }, node: { __id: id(this2), __resolveType: \\"Actor\\" } }) AS var3
                    }
                    RETURN { connection: { edges: var3, totalCount: totalCount } } AS var4
                }
                RETURN collect({ node: { movieTitle: this0.title, actors: var4, __resolveType: \\"Movie\\" } }) AS var5
            }
