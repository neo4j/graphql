...
describe("Create with labels", () => {
    ...
    beforeAll(() => {
        typeDefs = /* GraphQL */ `
            type Movie @node(labels: ["Film", "ShortMovie"]) {
                title: String!
                released: Int
            }
        `;
    ...
    test("should create two movies and project them", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                RETURN collect({ node: { title: this1.title, released: this1.released, __resolveType: \\"Movie\\" } }) AS var2
            }
