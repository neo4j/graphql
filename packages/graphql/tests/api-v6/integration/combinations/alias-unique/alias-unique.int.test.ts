...
describe("assertIndexesAndConstraints/alias-unique", () => {
    ...
    test("should throw an error when the constraint does not exist for the field", async () => {
        ...
        ).rejects.toThrow(`Missing constraint for ${Book.name}.internationalStandardBookNumber`);
    });
    ...
    test("should throw an error when the constraint exists for the field but under a different name", async () => {
        ...
        const cypher = `CREATE CONSTRAINT WRONG_NAME FOR (n:${Book.name}) REQUIRE n.internationalStandardBookNumber IS UNIQUE`;
    ...
    test("should not throw an error when all necessary constraints exist", async () => {
        ...
        const cypher = `CREATE CONSTRAINT CONSTRAINT_NAME FOR (n:${Book.name}) REQUIRE n.internationalStandardBookNumber IS UNIQUE`;
        await testHelper.executeCypher(cypher);
    ...
    test("should not throw if constraint exists on an additional label", async () => {
        ...
        const cypher = `CREATE CONSTRAINT CONSTRAINT_NAME FOR (n:${Comic.name}) REQUIRE n.internationalStandardBookNumber IS UNIQUE`;
