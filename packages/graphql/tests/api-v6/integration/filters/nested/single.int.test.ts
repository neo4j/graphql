...
describe("Relationship filters with single", () => {
    ...
    beforeAll(async () => {
        ...
        await testHelper.executeCypher(`
            ...
            CREATE (anotherKeanu:${Actor} {name: "Keanu"})
            CREATE (m1:${Movie} {title: "The Matrix"})<-[:ACTED_IN {year: 1999}]-(a1)
            CREATE (m1)<-[:ACTED_IN {year: 1999}]-(anotherKeanu)
    ...
    test("filter by nested node with single", async () => {
        const query = /* GraphQL */ `
            query {
                ${Movie.plural}(
    ...
    test("filter by nested relationship properties with single", async () => {
        const query = /* GraphQL */ `
            query {
                ${Movie.plural}(
    ...
    test("filter by nested relationship properties with single and OR operator", async () => {
        const query = /* GraphQL */ `
            query {
                ${Movie.plural}(
