...
describe("Relationship filters with none", () => {
    ...
    test("filter by nested node with none", async () => {
        const query = /* GraphQL */ `
            query {
                ${Movie.plural}(
    ...
    test("filter by nested relationship properties with none", async () => {
        const query = /* GraphQL */ `
            query {
                ${Movie.plural}(
    ...
    test("filter by nested relationship properties with none and OR operator", async () => {
        const query = /* GraphQL */ `
            query {
                ${Movie.plural}(
    ...
    test("filter by nested node with none and NOT operator", async () => {
        const query = /* GraphQL */ `
            query {
                ${Movie.plural}(
                    where: { edges: { node: { actors: { edges: { none: { NOT: { node: { name: { equals: "Keanu" } } } } } } } } }
                ) {
                    connection {
                        edges {
                            node {
