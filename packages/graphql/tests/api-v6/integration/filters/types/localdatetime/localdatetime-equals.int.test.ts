...
describe("LocalDateTime - Equals", () => {
    ...
    test("LocalDateTime equals", async () => {
        ...
        await testHelper.executeCypher(
            `
                   CREATE (:${Movie.name} {title: "The Matrix", localDateTime: $localdatetime1})
                   CREATE (:${Movie.name} {title: "The Matrix 2", localDateTime: $localdatetime2})
               `,
                    ...
                    edges: [
                        {
                            node: {
                                title: "The Matrix",
                                localDateTime: localdatetime1.toString(),
                            },
                        },
                    ],
                },
