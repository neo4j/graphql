...
describe.skip("CartesianPoint 2d EQ", () => {
    ...
    test("wgs-84-2d point filter by EQ", async () => {
        const query = /* GraphQL */ `
            query {
                ${Location.plural}(where: { edges: { node: { value: { equals: {  x: ${London.x}, y: ${London.y} } } } } }) {
                    connection {
                        edges {
                            node {
                                id
    ...
    test("wgs-84-2d point filter by NOT EQ", async () => {
        const query = /* GraphQL */ `
            query {
                ${Location.plural}(where: { edges: { node: { value: { NOT: { equals: { x: ${Paris.x}, y: ${Paris.y} } } } } } }) {
                    connection {
                        edges {
                            node {
                                id
