...
describe.skip("Point 2d IN", () => {
    ...
    test("wgs-84-2d point filter by IN", async () => {
        const query = /* GraphQL */ `
            query {
                ${Location.plural}(where: { edges: { node: { value: { in: [{ longitude: ${Rome.longitude}, latitude: ${Rome.latitude} }, { longitude: ${Paris.longitude}, latitude: ${Paris.latitude} }]  } } } }) {
                    connection {
                        edges {
                            node {
                                id
    ...
    test("wgs-84-2d point filter by NOT IN", async () => {
        const query = /* GraphQL */ `
            query {
                ${Location.plural}(where: { edges: { node: { value: { NOT: { in: [{ longitude: ${Rome.longitude}, latitude: ${Rome.latitude} }, { longitude: ${Paris.longitude}, latitude: ${Paris.latitude} }]  } } } } }) {
                    connection {
                        edges {
                            node {
                                id
