...
describe.skip("Point 3d GT", () => {
    ...
    test("wgs-84-3d point filter by GT", async () => {
        ...
        const query = /* GraphQL */ `
            query  {
                ${Location.plural}(where: { edges: { node: { value: { gt: { point: { longitude: ${Paris.longitude}, latitude: ${Paris.latitude}, height: ${Paris.height} }, distance: ${distance} } } } } }) {
                    connection {
                        edges {
                            node {
                                id
    ...
    test("wgs-84-3d point filter by NOT GT", async () => {
        ...
        const query = /* GraphQL */ `
            query  {
                ${Location.plural}(where: { edges: { node: { value: { NOT: { gt: { point: { longitude: ${Paris.longitude}, latitude: ${Paris.latitude}, height: ${Paris.height} }, distance: ${distance} } } } } } }) {
                    connection {
                        edges {
                            node {
                                id
