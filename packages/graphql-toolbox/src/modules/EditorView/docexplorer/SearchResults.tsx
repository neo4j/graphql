...
export default class SearchResults extends React.Component<SearchResultsProps, Record<string, unknown>> {
                    ...
                    const match = (
                        <div className="doc-category-item" key={typeName + "." + fieldName}>
                            ...
                            <a
                                ...
                                onKeyDown={(event) => onClickField(field, type, event as unknown as KeyboardEvent)}
