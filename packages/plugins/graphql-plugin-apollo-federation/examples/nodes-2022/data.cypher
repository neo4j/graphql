...
CREATE (:Review { score: 9, description: "Makes for a pretty good home for sponges and snails" })<-[:HAS_REVIEW]-(pineapple)
...
CREATE (:Review { score: 3, description: "Ever wanted a fruit that smells like your dirty socks? You're in the right place!" })<-[:HAS_REVIEW]-(durian)
CREATE (:Review { score: 5, description: "There's sherbet in my home, made out of watermelone!" })<-[:HAS_REVIEW]-(watermelon)
CREATE (:Review { score: 1, description: "Was a bit disappointed that it didn't contain a real dragon" })<-[:HAS_REVIEW]-(dragonfruit)
