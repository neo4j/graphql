...
const baseRules = {
    "no-underscore-dangle": ["warn", { allow: ["_on", "__resolveType", "__typename"] }], // TODO Refactor instances of _varName to remove dangling underscore, and delete this line (also fixes @typescript-eslint/naming-convention)
