...
It is also possible update nodes and to create duplicates of the same connection by specifying `createAsDuplicate: true` on connections that should not override existing ones.
