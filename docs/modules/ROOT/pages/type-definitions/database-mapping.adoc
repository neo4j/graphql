...
Please note that defining `labels` means you take control of the database labels of the node. Because indexes and constraints in the Neo4j database can only be assigned one label, for the moment the first label in the `labels` list will be used.
