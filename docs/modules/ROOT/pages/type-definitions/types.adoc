...
ISO 8601 duration string allowing for basic date time format stored as a https://neo4j.com/docs/cypher-manual/current/functions/temporal/duration/[Duration] type.
...
_Note:_ Decimal values are not currently accepted on `[YMWD]`
