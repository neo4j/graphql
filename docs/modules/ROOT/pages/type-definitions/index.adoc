...
- xref::type-definitions/infer-schema.adoc[Infer Schema] - If you have a existing database, you can learn how to automatically generate the type definition file from that.
