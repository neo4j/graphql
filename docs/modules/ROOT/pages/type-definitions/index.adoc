...
- xref::type-definitions/introspector.adoc[Infer GraphQL Type Definitions] - If you have a existing database, you can learn how to automatically generate the type definition file from that.
