...
- xref::type-definitions/unions-and-interfaces.adoc[Unions and Interfaces] - Learn about two GraphQL concepts, unions and interfaces, and how they map to the Neo4j database.
