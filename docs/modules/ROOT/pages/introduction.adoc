...
- Comprehensive authentication and authorization options (xref::auth/index.adoc[Auth]), and additional xref::type-definitions/schema-configuration.adoc[Schema Configuration] options
