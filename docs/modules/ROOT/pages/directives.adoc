...
Reference: xref::type-definitions/schema-configuration.adoc#type-definitions-schema-configuration-exclude[`@exclude`]
...
Reference: xref::type-definitions/schema-configuration.adoc#type-definitions-schema-configuration-readonly[`@readonly`]
...
Reference: xref::type-definitions/schema-configuration.adoc#type-definitions-schema-configuration-writeonly[`@writeonly`]
