...
The `neo4j-graphql-js` library would allow a user to configure the GraphQL schema via the `makeAugmentedSchema()` function to for instance exclude all queries and all mutations. See the example below:
[source, javascript, indent=0]
----
