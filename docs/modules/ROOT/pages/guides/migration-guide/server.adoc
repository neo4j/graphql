...
----
For more information regarding the above used `@exclude` directive, see xref::type-definitions/schema-configuration/index.adoc#type-definitions-schema-configuration-exclude[`@exclude`].
