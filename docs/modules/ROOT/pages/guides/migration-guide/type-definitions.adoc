...
* xref::type-definitions/schema-configuration.adoc#type-definitions-schema-configuration-exclude[`@exclude`]: Skip generation of specified Query/Mutation fields for an object type
