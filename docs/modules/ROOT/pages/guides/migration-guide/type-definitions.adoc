...
See xref::type-definitions/relationships.adoc#type-definitions-relationships[Relationships] for more information on relationships in `@neo4j/graphql`.
...
No change. See xref::type-definitions/cypher.adoc#type-definitions-cypher[`@cypher` directive] for more details on this directive in `@neo4j/graphql`.
