...
* xref::type-definitions/schema-configuration/index.adoc#type-definitions-schema-configuration-exclude[`@exclude`]: Skip generation of specified query/mutation fields for an object type
