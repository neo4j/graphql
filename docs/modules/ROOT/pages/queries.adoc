...
Count queries accepts an `where` argument for xref::filtering.adoc[Filtering] data.
...
Aggregation queries accepts an `where` argument for xref::filtering.adoc[Filtering] data.
