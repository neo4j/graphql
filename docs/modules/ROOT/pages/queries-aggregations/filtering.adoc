...
The following comparison operators are available for numeric types (`Int`, `Float`, xref::reference/type-definitions/types.adoc#type-definitions-types-bigint[`BigInt`]), xref::reference/type-definitions/types.adoc#type-definitions-types-temporal[Temporal Types] and xref::reference/type-definitions/types.adoc#type-definitions-types-spatial[Spatial Types]:
...
Filtering of spatial types is different to filtering of numerical types and also offers an additional filter - see xref::reference/type-definitions/types.adoc#type-definitions-types-spatial[Spatial Types].
...
Using the type definitions from xref::queries-aggregations/queries.adoc[Queries], below are some example of how filtering can be applied when querying for data.
