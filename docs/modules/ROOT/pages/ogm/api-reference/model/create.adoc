...
This method can be used to update nodes, and maps to the underlying xref::mutations/create.adoc#mutations-create[Create] Mutation.
...
|`input` +
 +
 Type: `any`
|JavaScript object representation of the GraphQL `input` input type used for xref::mutations/create.adoc#mutations-create[Create] mutations.
