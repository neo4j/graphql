...
NOTE: Note that authorization rules are not supported when applied over nested xref::reference/type-definitions/unions.adoc[unions] or xref::reference/type-definitions/interfaces.adoc[interfaces].
