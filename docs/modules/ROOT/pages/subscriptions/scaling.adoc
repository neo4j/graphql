...
instances. This can be achieved through different xref::subscriptions/subscription-mechanisms.adoc[subscription mechanisms].
...
NOTE: You can find examples of this pattern with `@neo4j/graphql` xref::subscriptions/subscription-mechanisms.adoc[here].
