...
The following comparison operators are available for numeric types (`Int`, `Float`, xref::type-definitions/types.adoc[`BigInt`]), xref::type-definitions/types.adoc[Temporal Types] and xref::type-definitions/types.adoc[Spatial Types]:
...
Filtering of spatial types is different to filtering of numerical types and also offers an additional filter - see xref::type-definitions/types.adoc[Spatial Types].
