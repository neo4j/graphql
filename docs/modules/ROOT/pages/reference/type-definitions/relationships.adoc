...
=== QueryDirection
All relationships have a direction, however, when querying it is possible to perform xref::queries-aggregations/queries.adoc#_undirected_queries[undirected queries].
