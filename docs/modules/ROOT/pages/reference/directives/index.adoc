...
Reference: xref::auth/auth-directive-subs.adoc[`@auth` directive]
...
Reference: xref::reference/directives/access-control.adoc#type-definitions-access-control-exclude[`@exclude`]
...
Reference: xref::reference/directives/access-control.adoc#type-definitions-access-control-readonly[`@readonly`]

== `@relationship`

The `@relationship` directive is used to configure relationships between object types.

Reference: xref::reference/type-definitions/relationships.adoc[Relationships]
...
Reference: xref::reference/directives/access-control.adoc#type-definitions-access-control-writeonly[`@writeonly`]
