...
- Comprehensive authentication and authorisation options (xref::auth/index.adoc[Auth]), and additional xref::reference/directives/schema-configuration/index.adoc[Schema Configuration] options
